[README.md](https://github.com/user-attachments/files/24212048/README.md)
# giang_sinh_an_lanh
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>cây ma thuật cho F5</title>
...
<body>
    ...
    <div id="ui-layer">
        ...
        <button id="btnStart" onclick="startSystem()">mở ra</button>
    </div>
    ...
    <script>
        ...
        function createDecorations() {
            ...
            lCtx.fillText("Tớ iu mấy cậu ❤️ ", 512, 130);
